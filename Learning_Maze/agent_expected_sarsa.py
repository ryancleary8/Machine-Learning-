# ============================================================================
# FILE: agent_expected_sarsa.py
# ============================================================================
"""Expected SARSA agent implementation for the grid-world maze."""
...
class ExpectedSARSAAgent(BaseAgent):
    """Expected SARSA agent using epsilon-greedy policy evaluation."""
    ...
    def _expected_value(self, state):
        ...
        action_prob = np.full(self.num_actions, self.epsilon / self.num_actions)
        action_prob[greedy_action] += 1.0 - self.epsilon
        return np.dot(action_prob, self.q_table[state])
    ...
    def update(self, state, action, reward, next_state, done):
        ...
        if done:
            ...
            expected_q = self._expected_value(next_state)
    ...
    def train(self, num_episodes, max_steps, episodes_to_save=None):
        ...
        print(f"Training Expected SARSA agent for {num_episodes} episodes...")
        print("-" * 60)
